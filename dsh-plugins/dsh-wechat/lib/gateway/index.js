...
import { API_TIMEOUT_MS, CONFIG_TIMEOUT_MS, ILINK_BASE_URL, LONG_POLL_TIMEOUT_MS, MESSAGE_DEDUP_TTL_SECONDS, RATE_LIMIT_ERRCODE, SESSION_EXPIRED_ERRCODE, WEIXIN_CDN_BASE_URL, isStaleSessionRet, } from "./types.js";
import { getConfig, getUpdates, qrLogin, sendMessage, sendTyping as sendTypingRaw, sleep, } from "./ilink-client.js";
import { DEFAULT_CDN_ALLOWLIST } from "./media.js";
