...
本目录收录了 5 个 Bilibili 视频素材，包含完整 720P MP4 视频文件、视频元数据、评论列表（JSON / JSONL 结构）以及部分视频的中文字幕。
...
| [BV1VB3v6WEfw](https://www.bilibili.com/video/BV1VB3v6WEfw) | 做个人 IP 不用真人出镜，我做了个一键生成 IP 动画视频的 Skill | 后端小肥肠 | 31.00 MB | 17041 | 569 | 117 | - | [`BV1VB3v6WEfw`](./BV1VB3v6WEfw/README.md) |
